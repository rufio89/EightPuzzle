...
public class BestFirstSearch {
    ...
    public BestFirstSearch(int[] initial, int[] goal){
    ...
    public void printStats(Node item, int totalVisited, int space){
        ...
        System.out.format("%5s%14d%12d%12d%12d", "GBF", current.getDepth(), totalCost, totalVisited, space);
        System.out.println();
    }
    ...
    //RUN BEST FIRST SEARCH ON THE TREE AS YOU BUILD
    public void run(){
        int space = 0;
        ...
        PriorityQueue<Node> queue = new PriorityQueue<Node>(new Comparator<Node>() {
            ...
            public int compare(Node n1, Node n2) {
                return Integer.compare(n1.getMisplacedTileCount(), n2.getMisplacedTileCount());
            }
        });
